...
Before releasing, a few things need to happen in order to finally release
...
Create a git tag and make sure the tag tag starts with `v` and follows the version. like:
...
publish the crates into [crates.io](https://crates.io/).
...
```
git commit -m "Bumping version to 1.1.0"
